...
Als Spielinspiration wurde unter anderem das Spiel "`Mewnbase"' \hyperref{https://cairn4.itch.io/mewnbase}{}{}{\textit{(itch.io)}} genutzt aufgrund seiner orthographischen Perspektive und des ähnlichen Spielkonzepts. Die Unterschiede zu "`Chance of Hell"' sind die Kulisse und ein weniger auf Überleben sondern mehr auf Aufbau einer Siedlung konzentriertes Spielgeschehen.\\
Ergänzend dazu diente auch "'Stardew Valley"' \hyperref{https://www.stardewvalley.net/}{}{}{\textit{(stardewvalley.net)}} als Inspiration in Bezug auf den Aspekts der Erweiterung und Erforschung der Siedlung.


\sectionspace
\section{Formale Elemente}\label{sec:Formale_Elemente}
Im folgenden werden formale Elemente, die wichtig für die Vorstellung des Spiels sind, vorgestellt.
