...
namespace Game.Resources {
	public static class ResourceHandler {
		...
		public static bool Available(Costs costs) {
			var wood  = Resources[ResourceType.Wood].Amount >= costs.wood;
			var stone = Resources[ResourceType.Stone].Amount >= costs.stone;
			var iron  = Resources[ResourceType.Iron].Amount >= costs.iron;
